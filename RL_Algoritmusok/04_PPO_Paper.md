...
A házirend gradiens módszerek úgy működnek, hogy kiszámítják a házirend gradiens becslését, és egy sztochasztikus gradiens emelkedési algoritmushoz csatlakoztatják. A leggyakrabban használt gradiensbecslő a következővel rendelkezik

ahol πθ egy sztochasztikus politika és ˆAt az előnyfüggvény becslése a t időpontban.
Itt az elvárás ˆEt[. . .] az empirikus átlagot jelzi egy véges mintakötegre egy olyan algoritmusban, amely a mintavétel és az optimalizálás között váltakozik. Automatikus alkalmazást használó megvalósítások
...
(3)
ˆEt[KL[πθold (· | st), πθ(· | st)]] ≤ δ függvénye. (4)
